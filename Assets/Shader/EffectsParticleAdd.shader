			...
			Program "vp" {
				...
				SubProgram "gles hw_tier00 " {
					...
					void main ()
					{
					  ...
					  lowp vec4 tmpvar_5;
					  tmpvar_5 = ((2.0 * tmpvar_1) * ((_TintColor * texture2D (_MainTex, xlv_TEXCOORD0)) * _ColorStrength));
				...
				SubProgram "gles3 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat0 = u_xlat0 * vec4(_ColorStrength);
					    SV_Target0 = u_xlat0;
					    return;
					}
				...
				SubProgram "vulkan hw_tier00 " {
					...
					; Schema: 0
					                                             ...
					                                             %1 = OpExtInstImport "GLSL.std.450" 
					                                                    OpMemoryModel Logical GLSL450 
					                                                    OpEntryPoint Fragment %4 "main" %11 %75 %100 %113 
					                                                    OpExecutionMode %4 OriginUpperLeft 
					                                                    OpDecorate %11 Location 11 
					...
					UniformConstant read_only Texture2DSampled* %23 = OpVariable UniformConstant 
					                                        ...
					                                        u32 %29 = OpConstant 0 
					                                            ...
					                                            %33 = OpTypeStruct %7 %7 %6 %6 
					                                            %34 = OpTypePointer Uniform %33 
					  Uniform struct {f32_4; f32_4; f32; f32;}* %35 = OpVariable Uniform 
					                                            %36 = OpTypeInt 32 1 
					                                        i32 %37 = OpConstant 0 
					                                        u32 %38 = OpConstant 2 
					...
					UniformConstant read_only Texture2DSampled* %97 = OpVariable UniformConstant 
					                 ...
					                 read_only Texture2DSampled %98 = OpLoad %97 
					                                     ...
					                                     f32_4 %105 = OpFMul %103 %104 
					                                                    OpStore %9 %105 
					                                     f32_4 %106 = OpLoad %9 
					                              Uniform f32* %108 = OpAccessChain %35 %107 
					                                       f32 %109 = OpLoad %108 
					                                     f32_4 %110 = OpCompositeConstruct %109 %109 %109 %109 
					                                     f32_4 %111 = OpFMul %106 %110 
					                                                    OpStore %9 %111 
					                                     f32_4 %114 = OpLoad %9 
					                                                    OpStore %113 %114 
					                                                    OpReturn
