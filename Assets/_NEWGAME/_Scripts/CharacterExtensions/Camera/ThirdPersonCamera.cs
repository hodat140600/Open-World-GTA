...
namespace _GAME._Scripts._Camera
{
    ...
    public class ThirdPersonCamera : MonoBehaviour
    {
        ...
        [_Scripts.LeoHideInInspector("autoBehindTarget")]
        ...
        [@HideInInspector]
        public ThirdPersonCameraState lerpState;
        ...
        public virtual void ChangeState(string stateName, bool hasSmooth)
        {
            ...
            ThirdPersonCameraState state = CameraStateList != null ? CameraStateList.tpCameraStates.Find(delegate (ThirdPersonCameraState obj) { return obj.Name.Equals(stateName); }) : new ThirdPersonCameraState("Default");
        ...
        public virtual void ChangeState(string stateName, string pointName, bool hasSmooth)
        {
            ...
            {
                // search for the camera state string name
                var state = CameraStateList.tpCameraStates.Find(delegate (ThirdPersonCameraState obj)
                {
        ...
        public virtual void RotateCamera(float x, float y)
        {
            ...
            if (!currentState.cameraMode.Equals(TPCameraMode.FixedAngle))
            {
                ...
                {
                    // free rotation 
                    mouseX += x * (ExtendInput.instance.inputDevice == InputDevice.Joystick ? currentState.xMouseSensitivity * joystickSensitivity : currentState.xMouseSensitivity);
                    mouseY -= y * (ExtendInput.instance.inputDevice == InputDevice.Joystick ? currentState.yMouseSensitivity * joystickSensitivity : currentState.yMouseSensitivity);
        ...
        protected virtual void CalculeLockOnPoint()
        {
            ...
            mouseY = Mathf.LerpAngle(mouseY, Extensions.ClampAngle(y, currentState.yMinLimit, currentState.yMaxLimit), lockTargetWeight);
            mouseX = Mathf.LerpAngle(mouseX, Extensions.ClampAngle(x, currentState.xMinLimit, currentState.xMaxLimit), lockTargetWeight);
        }
