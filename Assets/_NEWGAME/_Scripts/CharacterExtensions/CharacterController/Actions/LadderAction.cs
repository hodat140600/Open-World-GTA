...
{
    [ClassHeader("Ladder Action", iconName = "ThirdPersonExtensions/ladderIcon")]
    public class LadderAction : ActionListener
    {
        #region public variables

        [EditorToolbar("Settings", overrideChildOrder: true, order = 0)]
        ...
        [LeoReadOnly(false)]
        [SerializeField]
        protected TriggerLadderAction targetLadderAction;
        [LeoReadOnly(false)]
        [SerializeField]
        protected TriggerLadderAction currentLadderAction;
        //[vReadOnly(false)]
        //[SerializeField]
        protected List<TriggerLadderAction> actionTriggers = new List<TriggerLadderAction>();
        [LeoReadOnly(false)]
        [SerializeField]
        ...
        protected ThirdPersonInput tpInput;
        ...
        protected virtual void TriggerEnterLadder()
        {
            ...
            tpInput.cc.animator.SetInteger(AnimatorParameters.ActionState, 1);     // set actionState 1 to avoid falling transitions
        ...
        protected virtual void UsingLadder()
        {
            ...
            tpInput.cc.animator.SetFloat(AnimatorParameters.InputVertical, speed, 0.1f, Time.deltaTime);
        ...
        protected virtual void AddLadderTrigger(TriggerLadderAction _ladderAction)
        {
        ...
        protected virtual void RemoveLadderTrigger(TriggerLadderAction _ladderAction)
        {
        ...
        protected virtual void CheckForTriggerAction(Collider other)
        {
            ...
            var _ladderAction = other.GetComponent<TriggerLadderAction>();
            if (!_ladderAction)
            {
                return;
            }
        ...
        public virtual void ResetPlayerSettings()
        {
            ...
            inEnterLadderAnimation = false;
            enterLadderStarted = false;
            tpInput.cc.animator.SetInteger(AnimatorParameters.ActionState, 0);
