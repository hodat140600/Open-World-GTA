...
namespace _GAME._Scripts._CharacterController
{
    ...
    public class GenericInputDrawer : PropertyDrawer
    {
        ...
        void DrawInputEnum(SerializedProperty input, SerializedProperty isUnityInput, Rect rect, bool withKeys = false)
        {
            ...
            {
                PopupWindow.Show(rect, new GenericInputSelector
                ("Input for " + input.displayName, input.stringValue, withKeys, isUnityInput == null || isUnityInput.boolValue, (newInput, isKey) =>
                {
