...
namespace _GAME._Scripts._CharacterController
{
    public class ExtendInput : MonoBehaviour
    {
        ...
        private static ExtendInput _instance;
        public static ExtendInput instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = FindObjectOfType<ExtendInput>();
                    if (_instance == null)
                    {
                        _instance = new GameObject("InputType").AddComponent<ExtendInput>();
                        return _instance;
                    }
                }
                return _instance;
    ...
    public class GenericInput
    {
        ...
        public string buttonName
        {
            get
            {
                if (ExtendInput.instance != null)
                {
                    if (ExtendInput.instance.inputDevice == InputDevice.MouseKeyboard) return keyboard.ToString();
                    else if (ExtendInput.instance.inputDevice == InputDevice.Joystick) return joystick;
                    else return mobile;
                }
                return string.Empty;
            }
        ...
        public bool isKey
        {
            get
            {
                if (ExtendInput.instance != null && !isUnityInput)
                {
