...
namespace _GAME._Scripts._CharacterController
{
    ...
    [ClassHeader("MELEE INPUT MANAGER", iconName = "ThirdPersonExtensions/inputIcon")]
    public class MeleeCombatInput : ThirdPersonInput, IMeleeFighter
    {
        ...
        internal MeleeManager meleeManager;
        protected bool _isAttacking;
        public bool isAttacking { get => _isAttacking || cc.IsAnimatorTag("Attack"); protected set { _isAttacking = value; } }
        public bool isBlocking { get; protected set; }
        public bool isArmed { get { return meleeManager != null && (meleeManager.rightWeapon != null || meleeManager.leftWeapon != null && meleeManager.leftWeapon.meleeType != MeleeType.OnlyDefense); } }
        ...
        {
            cc.animator.SetInteger(AnimatorParameters.AttackID, AttackID);
            cc.animator.SetTrigger(AnimatorParameters.WeakAttack);
        }
        ...
        {
            cc.animator.SetInteger(AnimatorParameters.AttackID, AttackID);
            cc.animator.SetTrigger(AnimatorParameters.StrongAttack);
        }
        ...
        protected virtual void UpdateMeleeAnimations()
        {
            ...
            cc.animator.SetInteger(AnimatorParameters.AttackID, AttackID);
            cc.animator.SetInteger(AnimatorParameters.DefenseID, DefenseID);
            cc.animator.SetBool(AnimatorParameters.IsBlocking, isBlocking);
            cc.animator.SetFloat(AnimatorParameters.MoveSet_ID, meleeMoveSetID, .2f, dTime.deltaTime);
        ...
        public virtual void ResetMeleeAnimations()
        {
            ...
            cc.animator.SetBool(AnimatorParameters.IsBlocking, false);
        }
        ...
        {
            cc.animator.ResetTrigger(AnimatorParameters.WeakAttack);
            cc.animator.ResetTrigger(AnimatorParameters.StrongAttack);
        }
        ...
        {
            cc.animator.SetInteger(AnimatorParameters.RecoilID, recoilID);
            cc.animator.SetTrigger(AnimatorParameters.TriggerRecoil);
            cc.animator.SetTrigger(AnimatorParameters.ResetState);
            cc.animator.ResetTrigger(AnimatorParameters.WeakAttack);
            cc.animator.ResetTrigger(AnimatorParameters.StrongAttack);
        }

        public virtual void OnReceiveAttack(Damage damage, IMeleeFighter attacker)
        {
