...
{
    [ClassHeader("Input Manager", iconName = "ThirdPersonExtensions/inputIcon")]
    public class ThirdPersonInput : ExtendMonoBehaviour, IAnimatorMoveReceiver
    {
        ...
        [HelpBox("Check these options if you need to use the mouse cursor, ex: <b>2.5D, Topdown or Mobile</b>", HelpBoxAttribute.MessageType.Info)]
        public bool unlockCursorOnStart = false;
        public bool showCursorOnStart = false;
        [HelpBox("PC only - use it to toggle between run/walk", HelpBoxAttribute.MessageType.Info)]
        ...
        [@HideInInspector]
        public _Camera.ThirdPersonCamera tpCamera;         // access tpCamera info
        [@HideInInspector]
        ...
        [@HideInInspector]
        public ThirdPersonController cc;                   // access the ThirdPersonController component
        [@HideInInspector]
        public HUDController hud;                          // acess vHUDController component
        protected bool updateIK = false;
        protected bool isInit;
        [@HideInInspector] public bool lockMoveInput;
        protected InputDevice inputDevice { get { return ExtendInput.instance.inputDevice; } }
        ...
        {
            var tpCameras = FindObjectsOfType<_Camera.ThirdPersonCamera>();
        ...
        /// </summary>
        internal virtual AnimatorMoveSender animatorMoveSender { get; set; }

        /// <summary>
        /// Use Animator Move Event Sender <seealso cref="AnimatorMoveSender"/>
        /// </summary>
        ...
        public virtual bool UseAnimatorMove
        {
            ...
            set
            {
                ...
                if (_useAnimatorMove != value)
                {
                    if (value)
                    {
                        animatorMoveSender = gameObject.AddComponent<AnimatorMoveSender>();
    ...
    /// <summary>
    /// Interface to receive events from <seealso cref="AnimatorMoveSender"/>
    /// </summary>
    ...
    /// OnAnimatorMove Event Sender 
    /// </summary>
    class AnimatorMoveSender : MonoBehaviour
    {
        private void Awake()
        {
            ///Hide in Inpector
