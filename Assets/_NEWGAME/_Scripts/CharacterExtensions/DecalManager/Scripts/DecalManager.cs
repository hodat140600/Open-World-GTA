...
{
    [ClassHeader("Decal Manager", openClose = false)]
    public class DecalManager : ExtendMonoBehaviour
    {
        ...
        public class DecalObject
        {
            ...
            [SerializeField] protected ImpactEffectBase impactEffect;
            [SerializeField] protected List<ImpactEffectBase> additionalEffects;
