...
{
    public class FootStep : FootStepBase
    {
        ...
        [HelpBox("Enable or disable spawn particle when foot step is triggered")]
        [SerializeField] protected bool _spawnParticle = true;
        [HelpBox("Enable or disable spawn step mark when foot step is triggered")]
        [SerializeField] protected bool _spawnStepMark = true;
        [HelpBox("The step effect is spawned from on trigger enter event of the Foot Step Triggers. If you need to play step sound only by external events you need to disable this variable.<b>\n*Disable this to play step sound using animation events</b>")]
