...
{
    [ClassHeader("Animator Event Receiver")]
    public class AnimatorEventReceiver : ExtendMonoBehaviour
    {
        [Tooltip("Check this option if the Animator component is on the parent of this GameObject")]
        public bool getAnimatorInParent;
        [HelpBox("Use <b>vAnimatorEvent</b> on a AnimatorState to trigger a Event below", HelpBoxAttribute.MessageType.Info)]
        public List<dAnimatorEvent> animatorEvents;

        [Serializable]
        public class dAnimatorEvent
        {
            [Serializable]
