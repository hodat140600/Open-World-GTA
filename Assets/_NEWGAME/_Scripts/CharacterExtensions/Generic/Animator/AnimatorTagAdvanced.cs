...
namespace _GAME._Scripts._EventSystems
{
    public class AnimatorTagAdvanced : AnimatorTagBase
    {
        ...
        public class AdvancedTags
        {
            ...
            {
                tagName = tag;
                tagType = AnimatorEventTriggerType.AllByNormalizedTime;
            }
            ...
            public void UpdateEventTrigger(float normalizedTime, List<AnimatorStateInfos> stateInfos, int layer, float speed = 1, bool looping = false, bool inExit = false, bool debug = false)
            {
                ...
                if (!isEnter && !inExit && tagType != AnimatorEventTriggerType.EnterStateExitByNormalized &&
                ...
                if (!isExit && isEnter && tagType != AnimatorEventTriggerType.EnterByNormalizedExitState &&
