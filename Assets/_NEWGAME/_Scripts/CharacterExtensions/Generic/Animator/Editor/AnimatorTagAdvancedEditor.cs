...
{
    [CustomEditor(typeof(AnimatorTagAdvanced))]
    public class AnimatorTagAdvancedEditor : AnimatorTagEditor
    {
        public override bool DrawTag(SerializedProperty list, int index)
        {
            ...
            var _enumTagType = (AnimatorTagAdvanced.AnimatorEventTriggerType)enumTagType.enumValueIndex;
            switch (_enumTagType)
            {
                case AnimatorTagAdvanced.AnimatorEventTriggerType.AllByNormalizedTime:
                ...
                case AnimatorTagAdvanced.AnimatorEventTriggerType.EnterStateExitByNormalized:
                    ...
                    break;
                case AnimatorTagAdvanced.AnimatorEventTriggerType.EnterByNormalizedExitState:
