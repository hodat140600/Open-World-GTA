...
{
    [CustomEditor(typeof(BodySnappingControl))]
    public class BodySnappingControlEditor : EditorBase
    {
        SerializedProperty bones;
        GUIContent warning;
        BodySnappingControl bcontrol;
        float lineSize = 0.1f;
        ...
        protected override void OnEnable()
        {
            ...
            bcontrol = (BodySnappingControl)target;
        }
    ...
    [CustomPropertyDrawer(typeof(BodySnappingControl.BoneTransformSnapping))]
    public class vBoneSnappingDrawer : PropertyDrawer
    {
        ...
        readonly GUISkin skin = Resources.Load("dSkin") as GUISkin;
