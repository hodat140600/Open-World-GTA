...
using UnityEditor;
using UnityEngine;
[CustomEditor(typeof(SnapToBody))]
public class SnapToBodyEditor : Editor
{
    SnapToBody snapToBody;
    int index = 0;
    ...
    private void OnEnable()
    {
        ...
        snapToBody = target as SnapToBody;
    }

    private void OnSceneGUI()
    {
        snapToBody.bodySnap = snapToBody.transform.root.GetComponentInChildren<BodySnappingControl>();
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (snapToBody)
        {
            ...
            snapToBody.bodySnap = (BodySnappingControl)EditorGUILayout.ObjectField(snapToBody.bodySnap, typeof(BodySnappingControl), true);
            ...
            if (snapToBody.bodySnap)
            {
                if (snapToBody.bodySnap && snapToBody.bodySnap.boneSnappingList != null)
                {
                    try
                    {
                        ...
                        bones[0] = SnapToBody.manuallyAssignBone;
