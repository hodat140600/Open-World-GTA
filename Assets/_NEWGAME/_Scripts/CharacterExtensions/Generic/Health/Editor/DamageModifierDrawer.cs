...
{
    [CustomPropertyDrawer(typeof(DamageModifier))]
    public class DamageModifierDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (property.isExpanded)
            {
                ...
                using (new EditorGUI.IndentLevelScope())
                {
                    ...
                    if ((DamageModifier.FilterMethod)filterMethod.enumValueIndex != DamageModifier.FilterMethod.ApplyToAll)
                    {
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            if ((DamageModifier.FilterMethod)property.FindPropertyRelative("filterMethod").enumValueIndex != DamageModifier.FilterMethod.ApplyToAll)
            {
