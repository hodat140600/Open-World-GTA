...
namespace _GAME._Scripts
{
    ...
    public static class HealthControllerHelper
    {
        ...
        /// Encrease or Decrease <seealso cref="currentHealth"/>  respecting the <seealso cref="MaxHealth"/>
        /// </summary>
        /// <param name="receiver">Target to GetComponent <seealso cref="IHealthController"/> </param>
        ...
        /// </summary>
        /// <param name="gameObject">Target to GetComponent <seealso cref="IHealthController"/> </param>
        /// <returns></returns>
