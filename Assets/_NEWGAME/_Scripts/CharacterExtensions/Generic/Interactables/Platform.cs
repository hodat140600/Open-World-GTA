...
{
    public class Platform : ExtendMonoBehaviour
    {
        #region Variables
        ...
        void OnDrawGizmos()
        {
            ...
            foreach (PlatformPoint t in points)
            {
        ...
        {
            if (other.transform.parent != transform && other.transform.CompareTag("Player") && other.GetComponent<Character>() != null)
            {
        ...
        public class PlatformPoint
        {
            ...
            [_Scripts.LeoHideInInspector("useDefaultstayTime", true)]
            public float stayTime;
            public bool useDefaultSpeed = true;
            [_Scripts.LeoHideInInspector("useDefaultSpeed", true)]
