...
namespace _GAME._Scripts
{
    ...
    [ClassHeader("Simple Door", openClose = false)]
    public class SimpleDoor : ExtendMonoBehaviour
    {
        [LeoReadOnly]
        ...
        [_Scripts.LeoHideInInspector("autoClose"), Tooltip("Close the door only if door is completely opened\n**The TimeToClose will be used yet")]
        public bool closeOnlyWhenOpened;
        [Tooltip("Target angle of Opened door")]
        public float angleOfOpen = 90f;
        [_Scripts.LeoHideInInspector("autoOpen"), Tooltip("Min angle between character forward and door that  can auto open")]
        ...
        [_Scripts.LeoHideInInspector("autoClose"), Tooltip("Time to auto close door after Opened")]
        public float timeToClose = 1f;
        [Tooltip("Used when autoOpen or autoClose is checked")]
        public TagMask tagsToOpen = new List<string>() { "Player" };
