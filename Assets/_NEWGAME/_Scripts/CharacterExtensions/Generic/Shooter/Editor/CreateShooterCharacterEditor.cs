...
namespace _GAME._Scripts._CharacterController._Shooter
{
    ...
    public class CreateShooterCharacterEditor : EditorWindow
    {
        GUISkin skin;
        ...
        /// </summary>    
        [MenuItem("DatHQ/Shooter/Create Shooter Controller", false, 2)]
        public static void CreateNewCharacter()
        {
            GetWindow<CreateShooterCharacterEditor>();
        }
        ...
        public virtual void OnGUI()
        {
            ...
            {
                EditorGUILayout.HelpBox("This gameObject already contains the component ThirdPersonController", MessageType.Warning);
            }
        ...
        public virtual void Create()
        {
            ...
            _template.name = "ShooterController_" + charObj.gameObject.name;
            ...
            if (useGameController)
            {
                ...
                {
                    gC = new GameObject("GameController_Example");
            ...
            if (!addMeleeCombat)
            {
                var _meleeManager = _template.GetComponent<MeleeManager>();
                DestroyImmediate(_meleeManager as MeleeManager, true);
            }
