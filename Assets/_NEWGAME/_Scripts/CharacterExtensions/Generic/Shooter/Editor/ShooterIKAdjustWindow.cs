...
{
    using _GAME._Scripts._IK;
    using PlayerController;
    public class ShooterIKAdjustWindow : EditorWindow
    {
        public static ShooterIKAdjustWindow curWindow;
        public IShooterIKController ikController;
        ...
        public bool useLockCamera
        {
            get
            {
                return ikController is ILockCamera;
            }
        }
        ...
        public bool LockCamera
        {
            ...
            {
                if (useLockCamera)
                    return (ikController as ILockCamera).LockCamera;
                return false;
            }
            set
            {
                if (useLockCamera)
                    (ikController as ILockCamera).LockCamera = value;
            }
        }



        [MenuItem("DatHQ/Shooter/Open IK Adjust Window", priority = 100)]
        public static void InitEditorWindow()
        {
            if (!curWindow)
            {
                curWindow = GetWindow<ShooterIKAdjustWindow>("IK Adjust Window");
                curWindow.titleContent.image = Resources.Load("ThirdPersonExtensions/icon_d2") as Texture2D;
            }
        }
        ...
        void OnGUI()
        {
            ...
            if (skin == null) skin = Resources.Load("dSkin") as GUISkin;
            ...
            {
                {
                    if (ikController.WeaponIKAdjustList)
                    {
                        ...
                        weaponIKAdjustList = (WeaponIKAdjustList)EditorGUILayout.ObjectField(weaponIKAdjustList, typeof(WeaponIKAdjustList), false);
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    WeaponIKAdjust ikAdjust = CreateInstance<WeaponIKAdjust>();
                                ...
                                {
                                    var action = new UnityEngine.Events.UnityAction<WeaponIKAdjust>((ikAdjust) =>
                                    {
                                        ikController.WeaponIKAdjustList.weaponIKAdjusts.Add(ikAdjust);
                                        ikController.UpdateWeaponIK();
                                    ...
                                    PopupWindow.Show(selectorRect, new IKAjustSelector(ikController.CurrentActiveWeapon.weaponCategory, action, skin));
                                }
        ...
        public void CreateNewIKAdjustList(IShooterIKController targetShooterManager)
        {
            WeaponIKAdjustList ikAdjust = CreateInstance<WeaponIKAdjustList>();
        ...
        void ApplyOffsets(IKAdjust currentIKAdjust, IKSolver weaponArm, IKSolver supportWeaponArm)
        {
        ...
        void DrawWeaponIKSettings(WeaponIKAdjust currentWeaponIK)
        {
            GUILayout.BeginHorizontal();
            ...
            if (GUILayout.Button(currentWeaponIK.name, skin.GetStyle("PopUp")))
            {
                ...
                var action = new UnityEngine.Events.UnityAction<WeaponIKAdjust>((_ikAdjust) =>
                {
                ...
                PopupWindow.Show(selectorRect, new IKAjustSelector(ikController.CurrentActiveWeapon.weaponCategory, action, skin, currentWeaponIK));
            }
        ...
        void Update()
        {
            ...
            if (EditorApplication.isPlaying && !EditorApplication.isPaused)
            {
                ...
                if (Selection.activeTransform && (ikController == null || Selection.activeGameObject != ikController.gameObject && Selection.activeTransform.GetComponent<IShooterIKController>() != null))
                {
                    ikController = Selection.activeGameObject.GetComponent<IShooterIKController>();
                }
                Repaint();
            }
        ...
        public class IKSolverEditorHelper
        {
            ...
            public IKSolverEditorHelper(IKSolver iKSolver)
            {
    ...
    public class IKAjustSelector : PopupWindowContent
    {
        Vector2 scroll;
        public string weaponCategory;
        public List<WeaponIKAdjust> weaponIKAdjusts;
        WeaponIKAdjust selected;
        UnityEngine.Events.UnityAction<WeaponIKAdjust> onSelect;
        GUISkin skin;
        GUIStyle selectorStyle;
        bool canSelectNull;
        public IKAjustSelector(string weaponCategory, UnityEngine.Events.UnityAction<WeaponIKAdjust> onSelect, GUISkin skin, WeaponIKAdjust selected = null)
        {
        ...
        {
            weaponIKAdjusts = FindAssetsByType<WeaponIKAdjust>();
    ...
    {
        public List<WeaponIKAdjust> ikToAddDefault = new List<WeaponIKAdjust>();
        public static vIKMessage curWindow;
        public GUIStyle style = new GUIStyle(EditorStyles.helpBox);
        public Vector2 scroll;
        public static void InitEditorWindow(List<WeaponIKAdjust> ikToAddDefault)
        {
            if (!curWindow)
            {
                curWindow = GetWindow<vIKMessage>("IK Message Window");
        ...
        void OnGUI()
        {
            ...
            {
                EditorGUILayout.ObjectField(ikToAddDefault[i], typeof(WeaponIKAdjust), false);
    ...
    public class ShowMessage
    {
        static ShowMessage()
        {
            var weaponIKAdjusts = IKAjustSelector.FindAssetsByType<WeaponIKAdjust>();
            List<WeaponIKAdjust> ikToAddDefault = new List<WeaponIKAdjust>();
            if (weaponIKAdjusts.Count > 0)
            {
