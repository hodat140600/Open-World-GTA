...
namespace _GAME._Scripts._Utils
{
    ...
    {
        public static ThirdPersonInput targetCharacter;
        public static string spawnPointName;
        public static string sceneName;

        public static void LoadScene(string _sceneName, string _spawnPointName, ThirdPersonInput tpInput)
        {
            if (!tpInput) return;
            ...
            if (targetCharacter)
            {
                var listeners = targetCharacter.GetComponents<ISceneLoadListener>();
