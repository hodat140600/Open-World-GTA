...
namespace _GAME._Scripts
{
    ...
    [ClassHeader("SimpleTrigger", openClose = false, useHelpBox = true, helpBoxText = "Tags and Layer To Detect : Use this to filter tags and layer that can interact with trigger, Select Nothing  to ignore filter")]
    public class SimpleTrigger : ExtendMonoBehaviour
    {
        public static bool drawGizmos = true;
        [System.Serializable]
        public class vTriggerEvent : UnityEvent<Collider> { }
        [LeoButton("ToggleGizmos", "ToggleGizmos", typeof(SimpleTrigger), false)]
        public bool useFilter = true;
        public bool debugMode;
        public TagMask tagsToDetect = new List<string>() { "Player" };
