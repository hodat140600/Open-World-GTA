...
{
    [ClassHeader("Trigger Change Camera State", openClose = false)]
    public class TriggerChangeCameraState : ExtendMonoBehaviour
    {
        ...
        [HelpBox("Keep it empty to Reset back to Default")]
        ...
        public ThirdPersonInput tpInput;
        ...
        void OnTriggerEnter(Collider other)
        {
            if (other.gameObject.CompareTag("Player"))
            {
                ...
                {
                    tpInput = other.GetComponent<ThirdPersonInput>();
                }
