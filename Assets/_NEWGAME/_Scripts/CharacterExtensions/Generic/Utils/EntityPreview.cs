...
{
    [ClassHeader("Entity Preview")]
    public sealed class EntityPreview : ExtendMonoBehaviour
    {

#if UNITY_EDITOR
        public Color previewColor = new Color(1, 1, 1, 0.25f);
        public bool drawBase = true;
        [_Scripts.LeoHideInInspector("drawBase")] public float baseRadius = 1;
        public bool useCustomMesh;
        [_Scripts.LeoHideInInspector("useCustomMesh")] public Mesh previewMesh;
