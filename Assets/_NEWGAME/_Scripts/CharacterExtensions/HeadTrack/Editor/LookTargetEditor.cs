...
namespace _GAME._Scripts
{
    ...
    [CustomEditor(typeof(LookTarget))]
    public class LookTargetEditor : Editor
    {
        GUISkin skin;
        void OnEnable()
        {
        ...
        public override void OnInspectorGUI()
        {
            ...
            LookTarget lTarget = (LookTarget)target;
            ...
            lTarget.visibleCheckType = (LookTarget.VisibleCheckType)EditorGUILayout.EnumPopup("Visible check type", lTarget.visibleCheckType);
            ...
            if (lTarget.visibleCheckType != LookTarget.VisibleCheckType.None)
            {
                ...
                if (lTarget.visibleCheckType == LookTarget.VisibleCheckType.BoxCast)
                {
