...
namespace _GAME._Scripts._CharacterController
{
    public class LookTarget : MonoBehaviour
    {
        ...
        [System.Serializable]
        public class OnLookEvent : UnityEngine.Events.UnityEvent<HeadTrack> { }
        ...
        internal void EnterLook(HeadTrack vHeadTrack)
        {
            onEnterLook.Invoke(vHeadTrack);
        }

        internal void ExitLook(HeadTrack vHeadTrack)
        {
    ...
    #region Helper
    public static class dLookTargetHelper
    {
        struct LookPoints
        {
