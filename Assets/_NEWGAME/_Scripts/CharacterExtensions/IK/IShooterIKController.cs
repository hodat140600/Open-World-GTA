...
{
    using _IK;
    using _CharacterController._Shooter;
    ...
    public partial interface IShooterIKController
    {
        ...
        /// </summary>
        IKSolver RightIK { get; }
        /// <summary>
        /// List with all adjusts
        /// </summary>
        WeaponIKAdjustList WeaponIKAdjustList { get; set; }
        /// <summary>
        /// Current IK with adjusts for current weapon
        /// </summary>
        WeaponIKAdjust CurrentWeaponIK { get; }
        /// <summary>
        ...
        /// </summary>
        ShooterWeapon CurrentActiveWeapon { get; }
