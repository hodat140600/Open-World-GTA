...
namespace _GAME._Scripts._CharacterController._Shooter
{
    ...
    [CreateAssetMenu(menuName = "DatHQ/Shooter/New Weapon IK Adjust")]
    public class WeaponIKAdjust : ScriptableObject
    {
        ...
        public virtual string GetDefaultStateName(IShooterIKController controller)
        {
            bool IsAiming = controller.IsAiming;
            bool IsCrouching = controller.IsCrouching;
            return /*If*/IsAiming ? IsCrouching ? CrouchingAimingState : StandingAimingState :
                                    /*else*/
                                    IsCrouching ? CrouchingState : StandingState;
        }
