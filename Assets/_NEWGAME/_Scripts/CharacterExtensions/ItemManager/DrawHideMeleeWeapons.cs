...
namespace _GAME._Scripts
{
    ...
    [ClassHeader("Draw/Hide Melee Weapons", "This component works with ItemManager, WeaponHolderManager and MeleeCombatInput", useHelpBox = true)]
    public class DrawHideMeleeWeapons : ExtendMonoBehaviour
    {
        [EditorToolbar("Default")]
        public bool hideWeaponsAutomatically = true;
        [LeoHideInInspector("hideWeaponsAutomatically")]
