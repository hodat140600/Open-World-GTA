...
namespace _GAME._Scripts._ItemManager
{
    ...
    [ClassHeader("Inventory")]
    public class Inventory : ExtendMonoBehaviour
    {
        #region Item Variables

        // delegates to help handle items
        public delegate List<Item> GetItemsDelegate();
        public delegate void AddItemDelegate(ItemReference itemReference, bool immediate = true, UnityEngine.Events.UnityAction<Item> onFinish = null);
        ...
        /// <summary>
        /// Action to get all items from your <seealso cref="ItemListData"/>
        /// </summary>
        ...
        [HelpBox("True: Play Item animation when the timeScale is 0 \n False: Ignore Item animation if timeScale equals 0")]
        ...
        {
            var _itemManager = GetComponentInParent<ItemManager>();
        ...
        protected virtual void SetCurrentSelectedArea(EquipArea equipArea)
        {
        ...
        protected virtual void ChangeEquipmentInput()
        {
            ...
            if (changeEquipmentControllers.Count > 0 && canEquip)
            {
                foreach (ChangeEquipmentControl changeEquip in changeEquipmentControllers)
                {
                    ...
                    {
                        if (ExtendInput.instance.inputDevice == InputDevice.MouseKeyboard || ExtendInput.instance.inputDevice == InputDevice.Mobile)
                        {
                        ...
                        else if (ExtendInput.instance.inputDevice == InputDevice.Joystick)
                        {
        ...
        internal virtual void OnUseItem(Item item)
        {
        ...
        internal virtual void OnDestroyItem(Item item, int amount)
        {
        ...
        /// <param name="item"></param>
        /// <param name="amount"></param>
        internal virtual void OnDropItem(Item item, int amount)
        {
        ...
        /// <param name="equipArea"></param>
        /// <param name="item"></param>
        public virtual void OnEquipItem(EquipArea equipArea, Item item)
        {
        ...
        /// <param name="equipArea"></param>
        /// <param name="item"></param>
        public virtual void OnUnequipItem(EquipArea equipArea, Item item)
        {
        ...
        protected virtual void ChangeEquipmentDisplay(EquipArea equipArea, Item item, bool removeItem = true)
        {
