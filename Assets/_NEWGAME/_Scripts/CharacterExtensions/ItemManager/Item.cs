...
namespace _GAME._Scripts._ItemManager
{
    ...
    public partial class Item : ScriptableObject
    {
        ...
        [HelpBox("Triggers a animation when Equipping a Weapon or enabling item.\nYou can also trigger an animation if the ItemType is a Consumable")]
        public string EnableAnim = "LowBack";
        [HelpBox("Triggers a animation when Unequipping a Weapon or disable item")]
        public string DisableAnim = "LowBack";
        [HelpBox("Delay to enable the Weapon/Item object when Equipping\n If ItemType is a Consumable use this to delay the item usage.")]
        public float enableDelayTime = 0.5f;
        [HelpBox("Delay to hide the Weapon/Item object when Unequipping")]
        public float disableDelayTime = 0.5f;
        [HelpBox("If the item is equippable use this to set a custom handler to instantiate the SpawnObject")]
        public string customHandler;
        [HelpBox("If the item is equippable and need to use two hand\n<color=yellow><b>This option makes it impossible to equip two items</b></color>")]
        ...
        /// <summary>
        /// Get the Item Attribute via <seealso cref="ItemAttribute"/>
        /// </summary>
        /// <param name="attribute"></param>
        /// <returns></returns>
        public ItemAttribute GetItemAttribute(ItemAttributes attribute)
        {
        ...
        /// <summary>
        /// Get Selected Item Attributes via <seealso cref="ItemAttribute"/> by ignoring the ones you don't want
        /// </summary>
        /// <param name="ignore"></param>
        /// <returns></returns>
        public string GetItemAttributesText(List<ItemAttributes> ignore = null)
        {
        ...
        /// <returns></returns>
        public string GetFullItemDescription(string format = null, List<ItemAttributes> ignoreAttributes = null)
        {
            string text = "";
