...
namespace _GAME._Scripts._ItemManager
{
    ...
    [ClassHeader("ItemManager")]
    public partial class ItemManager : ExtendMonoBehaviour, IActionReceiver
    {
        #region Delegates
        ...
        public delegate void CanUseItemDelegate(Item item, ref List<bool> validationList);

        #endregion

        #region Variables        

        [HelpBox("Place a Inventory Prefab inside your Character, it will be auto-assigned when you enter Playmode." +
            "\nYou can find the prefab at the Inventory/Prefabs folder", HelpBoxAttribute.MessageType.Info)]
        public Inventory inventory;

        [HelpBox("You can find the default ItemListData at the Inventory/ItemListData folder, or create a new list at the DatHQ Menu", HelpBoxAttribute.MessageType.Info)]
        ...
        /// </summary>
        public Dictionary<Item, Equipment> equipments = new Dictionary<Item, Equipment>();
        public Dictionary<GameObject, Equipment> equipmentsObject = new Dictionary<GameObject, Equipment>();
        ...
        public IAnimatorStateInfoController animatorStateInfos;
        ...
        IEnumerator Start()
        {
            ...
            if (inventory)
            {
                ...
                var melee = GetComponent<MeleeCombatInput>();
                if (melee)
                {
        ...
        /// <summary>
        /// This is just an example of saving the current items <seealso cref="SaveLoadInventory"/>
        /// </summary>
        ...
        /// <summary>
        /// This is just an example of loading the saved items <seealso cref="SaveLoadInventory"/>
        /// </summary>
        ...
        /// <summary>
        /// Check if Area need be locked, based in <see cref="Item.twoHandWeapon"/>
        /// </summary>
        protected virtual void CheckIsLockedToEquip()
        {
            var rightArea = Array.Find(inventory.equipAreas, a => a.equipPointName.Equals("RightArm"));
            var leftArea = Array.Find(inventory.equipAreas, a => a.equipPointName.Equals("LeftArm"));
        ...
        /// <summary>
        /// Check if the current Item is checked with the option <seealso cref="Item.twoHandWeapon"/>, if so, it will Unequip the opposite hand
        /// </summary>
        /// <param name="equipPoint"></param>
        /// <param name="item"></param>
        [Obsolete("This method will be removed in the future.\n use CheckIsLockedToEquip Method")]
        protected virtual void CheckTwoHandItem(EquipPoint equipPoint, Item item)
        {
            if (item == null)
            {
                return;
        ...
        public virtual Item GetItemInEquipPoint(string equipPointName)
        {
        ...
        /// <param name="id">Item id</param>
        /// <returns></returns>
        public virtual List<Item> GetItems(int id)
        {
        ...
        /// <param name="itemName">Item Name</param>
        /// <returns></returns>
        public virtual List<Item> GetItems(string itemName)
        {
        ...
        /// <seealso cref="Inventory.equipAreas"/>
        /// </summary>
        /// <param name="indexOfArea">index of equip area</param>
        /// <returns></returns>
        public virtual List<Item> GetItemsInEquipArea(int indexOfArea)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual List<Item> GetAllItemInAllEquipAreas()
        {
            var list = new List<Item>();
            if (!inventory || inventory.equipAreas.Length == 0)
            {
        ...
        protected Equipment EquipEquipment(Item item, bool startActive = true)
        {
            ...
            else
            {
                ...
                {
                    var equipment = item.originalObject.GetComponent<Equipment>();
                    ...
                    if (equipment != null)
                    {
                        ...
                        if (!startActive)
                        {
                            if (debugMode)
                            {
                                Debug.Log($"<color=green>Instantiate and disable Equipment {equipmentClone.gameObject} </color>");
                            }
                        ...
                        else
                        {
                            if (debugMode)
                            {
                                Debug.Log($"<color=green>Instantiate and enable Equipment {equipmentClone.gameObject} </color>");
                            }
                        }
                        ...
                        equipment = equipmentClone.GetComponent<Equipment>();
        ...
        protected Equipment EquipEquipment(Item item, Vector3 position, Quaternion rotation, Transform parent = null)
        {
            Equipment equipment = EquipEquipment(item);
            if (equipment)
            {
                if (parent)
                {
        ...
        protected void UnequipEquipment(Item item)
        {
            if (equipments.ContainsKey(item))
            {
                if (debugMode)
        ...
        public virtual void AddItem(ItemReference itemReference, bool ignoreItemAnimation = false, UnityEngine.Events.UnityAction<Item> onFinish = null)
        {
        ...
        public virtual void AutoEquipItem(Item item, int indexArea, bool autoEquip = false, bool ignoreItemAnimation = true)
        {
            if (!inventory)
            {
                return;
        ...
        /// <param name="item"></param>        
        protected virtual void EquipItem(EquipArea equipArea, Item item)
        {
            ...
            if (equipPoint != null && item != null && equipPoint.equipmentReference.item != item)
            {
                ...
                if (item.originalObject)
                {
                    var equipment = item.originalObject.GetComponentInChildren<Equipment>();
                    if (equipment != null)
                    {
        ...
        /// <param name="item"></param>
        /// <returns></returns>
        IEnumerator EquipItemRoutine(EquipPoint equipPoint, Item item, UnityEngine.Events.UnityAction onFinish)
        {
        ...
        /// </summary>
        /// <param name="indexOfArea">Index of <seealso cref="Inventory.equipAreas"/></param>
        /// <param name="indexOfSlot">Index of Slot in <seealso cref="EquipArea"/></param>
        /// <param name="item"><seealso cref="vItem"/> to Equip</param>
        /// <param name="ignoreItemAnimation">Ignore the Enable/Disable animation of your item</param>
        public virtual void EquipItemToEquipSlot(int indexOfArea, int indexOfSlot, Item item, bool autoEquip = false, bool ignoreItemAnimation = false)
        {
            if (!inventory)
            {
                return;
        ...
        /// <param name="indexOfArea">Index of Equip area</param>
        /// <param name="ignoreItemAnimation">Ignore the Enable/Disable animation of your item</param>
        public virtual void EquipItemToCurrentEquipSlot(Item item, int indexOfArea, bool ignoreItemAnimation = true)
        {
        ...
        /// <param name="equipArea"></param>
        /// <param name="item"></param>     
        protected virtual void UnequipItem(EquipArea equipArea, Item item)
        {
            if (!item)
            {
                return;
        ...
        /// <param name="item"></param>    
        /// <param name="ignoreItemAnimation">Ignore the Enable/Disable animation of your item</param>
        public virtual void UnequipItem(Item item, bool ignoreItemAnimation = true)
        {
            var equipArea = Array.Find(inventory.equipAreas, e => e.ValidSlots.Exists(s => s.item != null && s.item.id.Equals(item.id)));
            if (equipArea != null)
            {
                if (ignoreItemAnimation)
                {
        ...
        IEnumerator UnequipItemRoutine(EquipPoint equipPoint, Item item, UnityEngine.Events.UnityAction onFinish)
        {
            LockInventoryInput(true);
        ...
        /// </summary>
        /// <param name="item"></param>      
        protected IEnumerator UseItemRoutine(Item item)
        {
            usingItem = true;
            LockInventoryInput(true);
        ...
        /// </summary>
        /// <param name="item"></param>
        public virtual void DestroyItem(Item item)
        {
        ...
        public virtual void DestroyItem(Item item, int amount)
        {
            item.amount -= amount;
        ...
        public virtual void DropAllItens()
        {
            ...
            for (int i = 0; i < dropObjects.Count; i++)
            {
                ...
                if (dropObjectPrefab)
                {
                    ...
                    if (!collection)
                    {
                        collection = dropObject.AddComponent<ItemCollection>();
                    }
        ...
        protected virtual IEnumerator CollectItemsRoutine(float onCollectDelay = 0, float textDelay = 0, bool ignoreItemAnimation = true)
        {
            ...
            for (int i = 0; i < itemsToCollect.Count; i++)
            {
                ...
                onFinish = (_item) => { collectedItemInfo.item = _item; collectedItems.Add(collectedItemInfo); equipAction?.Invoke(_item); };
        ...
        /// <summary>
        /// Show a list of collected item in <see cref="ItemCollectionDisplay"/>
        /// </summary>
        ...
        protected virtual IEnumerator DisplayCollectedItems(float delay, params CollectedItemInfo[] _items)
        {
            for (int i = 0; i < _items.Length; i++)
            {
                ...
                if (ItemCollectionDisplay.Instance)
                {
                    var text = $"Acquired: {_items[i].amount} {_items[i].item.name}";
                    ItemCollectionDisplay.Instance.FadeText(text, 4, 0.25f);
                }
        ...
        /// <summary>
        /// Event called by <seealso cref="ActionListener"/> 
        /// </summary>
        /// <param name="action"></param>
        public virtual void OnReceiveAction(TriggerGenericAction action)
        {
            ...
            if (collection != null)
            {
                ...
                {
                    var itemCol = collection.items.dCopy();
    ...
    public class ItemReference
    {
        ...
        {
            ItemReference clone = new ItemReference(id);

            clone.name = name;
            clone.amount = amount;
            clone.autoEquip = autoEquip;
            clone.addToEquipArea = addToEquipArea;
            clone.indexArea = indexArea;
            clone.changeAttributes = changeAttributes;
    ...
    /// <summary>
    /// Interface used to register <see cref="EquipPoint.onInstantiateEquiment"/> event from <see cref="ItemManager.RegisterDefaultEquipPointListeners"/>
    /// </summary>
