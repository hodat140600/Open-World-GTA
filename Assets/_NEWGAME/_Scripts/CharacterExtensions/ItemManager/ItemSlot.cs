...
namespace _GAME._Scripts._ItemManager
{
    ...
    [ClassHeader("Item Slot", openClose = false)]
    public class ItemSlot : ExtendMonoBehaviour, IPointerClickHandler, ISelectHandler, IDeselectHandler, ISubmitHandler, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        private void UpdateDisplays(Item item)
        {
        ...
        /// </summary>
        /// <param name="item">target item</param>
        protected virtual void ChangeDisplayType(Item item)
        {
            if (item)
            {
        ...
        protected virtual void ChangeDisplayAttributes(Item item)
        {
            if (item)
            {
        ...
        /// </summary>
        /// <param name="item"></param>
        protected virtual void ChangeDisplayIcon(Item item)
        {
            if (icon && item)
            {
        ...
        /// </summary>
        /// <param name="item"></param>
        protected virtual void ChangeDisplayDescription(Item item)
        {
            if (item)
            {
        ...
        /// </summary>
        /// <param name="item"></param>
        protected virtual void ChangeDisplayAmount(Item item)
        {
            string amountText = "";
        ...
        /// </summary>
        /// <param name="item"></param>
        protected virtual void ChangeDisplayName(Item item)
        {
            if (item)
            {
        ...
        public virtual void OnPointerClick(PointerEventData eventData)
        {
            ...
            if (ExtendInput.instance.inputDevice == InputDevice.Mobile)
#else
            //if (vInput.instance.inputDevice == InputDevice.MouseKeyboard)
#endif
            {
