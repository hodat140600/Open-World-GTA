...
{
    [System.Serializable]
    public class OnHandleSlot : UnityEvent<ItemSlot> { }
    [System.Serializable]
    public class OnCompleteSlotList : UnityEvent<List<ItemSlot>> { }

    [ClassHeader("Item Window", openClose = false)]
    public class ItemWindow : ExtendMonoBehaviour
    {
        [LeoReadOnly] public Item currentItem;
        public ItemSlot slotPrefab;
        public RectTransform contentWindow;
        public List<ItemSlot> slots;
        public List<ItemType> supportedItems;
        ...
        UnityAction<ItemSlot> onSubmitSlotCallback;
        UnityAction<ItemSlot> onSelectCallback;
        ...
        public virtual void CreateEquipmentWindow(List<Item> items, UnityAction<ItemSlot> onPickUpItemCallBack = null, UnityAction<ItemSlot> onSelectSlotCallBack = null, bool destroyAdictionSlots = true)
        {
            StartCoroutine(CreateEquipmentWindowRoutine(items, onPickUpItemCallBack, onSelectSlotCallBack, destroyAdictionSlots));
        }

        public virtual void CreateEquipmentWindow(List<Item> items, List<ItemType> type, Item currentItem = null, UnityAction<ItemSlot> onPickUpItemCallback = null, UnityAction<ItemSlot> onSelectSlotCallBack = null)
        {
        ...
        protected virtual IEnumerator CreateEquipmentWindowRoutine(List<Item> items, UnityAction<ItemSlot> onPickUpItemCallBack = null, UnityAction<ItemSlot> onSelectSlotCallBack = null, bool destroyAdictionSlots = true)
        {
            ...
            else
            {
                ...
                //  if (updateSlotCount)
                {
                    for (int i = 0; i < _items.Count; i++)
                    {
                        ...
                        {
                            slot = Instantiate(slotPrefab) as ItemSlot;
        ...
        public virtual void OnSelect(ItemSlot slot)
        {
            currentSelectedSlot = slot;
