...
{
    [ClassHeader("Master Window", openClose = false)]
    public class MasterWindow : ExtendMonoBehaviour
    {
        [HelpBox("Window that always opens when this window is activated")]
        public GameObject mainWindow;
        public bool sequenceWindows;
        [LeoReadOnly]
        public MasterWindow parentWindow;
        [LeoReadOnly]
        ...
        {
            if (!parentWindow) parentWindow = transform.parent.GetComponentInParent<MasterWindow>();
        }
