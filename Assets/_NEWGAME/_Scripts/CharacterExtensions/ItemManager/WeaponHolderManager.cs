...
namespace _GAME._Scripts._ItemManager
{
    ...
    public class WeaponHolderManager : ExtendMonoBehaviour
    {
        ...
        internal ThirdPersonController cc;
        ...
        public void CheckAreaLockedToEquip(EquipArea equipArea)
        {
        ...
        internal WeaponHolder GetHolder(GameObject equipment, int id)
        {
            ...
            {
                if (debugMode) Debug.LogWarning(ToString() + " fail to find a holder with equipPointName " + equipPoint.equipPointName);
                return null;
            }
        }
