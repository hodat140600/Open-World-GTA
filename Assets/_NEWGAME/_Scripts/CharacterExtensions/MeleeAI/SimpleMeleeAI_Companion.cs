...
{
    public class SimpleMeleeAI_Companion : SimpleMeleeAI_Controller
    {
        [EditorToolbar("Companion")]
        ...
        /// <summary>
        /// Gets a value indicating whether this <see cref="SimpleMeleeAI_Companion"/> is near of companion. Relative to <see cref="companionMaxDistance"/>
        /// </summary>
        ...
        /// <summary>
        /// override <see cref="SimpleMeleeAI_Companion.StateRoutine()"/>
        ...
        /// <summary>
        /// override <see cref="SimpleMeleeAI_Companion.Idle()"/>
        /// </summary>
        /// <returns></returns>
