...
namespace _GAME._Scripts._CharacterController._AI
{
    ...
    public class SimpleMeleeAI_Motor : Character
    {
        #region Variables
        ...
        public SimpleMeleeAI_SphereSensor sphereSensor;
        public TagMask tagsToDetect = new TagMask { "Player" };
        ...
        [HideInInspector]
        public d_SpriteHealth healthSlider;
        ...
        public struct CharacterTarget
        {
            ...
            public IHealthController character;
            public Collider colliderTarget;
        }
        protected Vector3 targetPos;
        [SerializeField, LeoReadOnly]
        ...
        protected List<Point> visitedPatrolPoint = new List<Point>();
        protected List<Waypoint> visitedWaypoint = new List<Waypoint>();
        #endregion
        ...
        public override void Init()
        {
            ...
            sphereSensor = GetComponentInChildren<SimpleMeleeAI_SphereSensor>();
            if (sphereSensor)
            {
            ...
            healthSlider = GetComponentInChildren<d_SpriteHealth>();
        ...
        {
            tryingBlock = true;
            float randomBlock = Random.value;
