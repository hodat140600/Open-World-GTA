...
namespace _GAME._Scripts._Melee
{
    ...
    [ClassHeader("Melee Object", openClose = false)]
    public class MeleeAttackObject : ExtendMonoBehaviour
    {
        [LeoReadOnly(false)] public string attackObjectName;
        ...
        /// </summary>
        [HelpBox("Event called when attack was successful")]
        public OnHitEnter onDamageHit;
        /// <summary>
        /// Event called when the attack causes recoil
        /// </summary>
        [HelpBox("Event called when the attack causes recoil")]
        public OnHitEnter onRecoilHit;
        /// <summary>
        /// Event called when causes damage 
        /// </summary>
        [HelpBox("Event called when causes damage ")]
        public OnReceiveDamage onPassDamage;
        [HelpBox("Events called when  Damage applier (HitBoxes) is enabled or disabled ")]
        ...
        /// <summary>
        /// Attack Object name is used to be selected from the <see cref="_Melee.MeleeManager.Members"/> list
        /// </summary>
        ...
        protected virtual void Start()
        {
            ...
            targetColliders = new Dictionary<HitBox, List<GameObject>>();
        ...
        public virtual void OnHit(HitBox hitBox, Collider other)
        {
            ...
            if (canApplyDamage && !targetColliders[hitBox].Contains(other.gameObject) && meleeManager != null && other.gameObject != meleeManager.gameObject)
            {
                ...
                // recoil conditions  
                else if ((hitBox.triggerType & HitBoxType.Recoil) != 0 &&
        ...
        public bool ApplyDamage(HitBox hitBox, Collider other, Damage damage)
        {
