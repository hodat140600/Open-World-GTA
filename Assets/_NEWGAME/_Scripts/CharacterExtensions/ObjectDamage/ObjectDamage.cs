...
{
    [ClassHeader("OBJECT DAMAGE", iconName = "ThirdPersonExtensions/DamageIcon")]
    public class ObjectDamage : ExtendMonoBehaviour
    {
        [System.Serializable]
        ...
        protected virtual void ApplyDamage(Collider target, Vector3 hitPoint)
        {
            ...
            target.gameObject.ApplyDamage(new Damage(damage));
            onHit.Invoke(target);
        }
    }
}