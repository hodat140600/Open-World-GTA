...
{
    [ClassHeader("RAGDOLL SYSTEM", true, "ThirdPersonExtensions/ragdollIcon", true, "Every gameobject children of the character must have their tag added in the IgnoreTag List.")]
    public class Ragdoll : ExtendMonoBehaviour
    {
        #region public variables       
        [EditorToolbar("Debug")]
        public bool startRagdolled = false;
        [LeoButton("Active Ragdoll And Keep Ragdolled", "ActivateRagdollWithDelayToGetUp", typeof(Ragdoll))]
        [LeoButton("Active Ragdoll", "ActivateRagdoll", typeof(Ragdoll))]
        ...
        public void ActivateRagdoll(Damage damage, float timeToStayRagdolled)
        {
        ...
        // ragdoll blend - code based on the script by Perttu H�m�l�inen with modifications to work with this Controller        
