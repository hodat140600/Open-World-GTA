...
namespace _GAME._Scripts._CharacterController._Shooter
{
    ...
    [ClassHeader("Draw/Hide Shooter Melee Weapons", "This component works with vItemManager, vWeaponHolderManager and vShooterMeleeInput", useHelpBox = true)]
    public class DrawHideShooterWeapons : ExtendDrawHideMeleeWeapons
    {
        public virtual ShooterMeleeInput shooter { get; set; }
        [EditorToolbar("Shooter")]
        ...
        {
            base.Start();
            shooter = GetComponent<ShooterMeleeInput>();
        }
