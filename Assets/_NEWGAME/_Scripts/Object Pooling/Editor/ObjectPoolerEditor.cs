...
public class ObjectPoolerEditor : Editor
{
    ...
    void OnEnable()
    {
        logoTex = (Texture2D)EditorGUIUtility.Load("Assets/_NEWGAME/_Scripts/Object Pooling/Editor/Images/PoolerHeader.png");
        backGroundTex = (Texture2D)EditorGUIUtility.Load("Assets/_NEWGAME/_Scripts/Object Pooling/Editor/Images/PoolerBg.png");
