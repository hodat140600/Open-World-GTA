...
namespace MyPooler
{
    [ClassHeader("ObjectPooling", iconName = "ThirdPersonExtensions/controllerIcon")]
    public class ObjectPooler : ExtendMonoBehaviour
    {
        [System.Serializable]
        public class Pool
        {
        ...
        [EditorToolbar("Debug", order = 3)]
        public bool isDebug = false;
        [EditorToolbar("DestroyOnLoad", order = 2)]
        public bool shouldDestroyOnLoad = false;
        private int extensionSize;
        [EditorToolbar("Pooling", order = 2)]
